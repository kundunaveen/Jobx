...
class EmployeeExperienceController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        try {
            ...
            return Redirect::route('employee.home')->with('success', 'Your experience data saved successful');
    ...
    public function destroy(string $uuid)
    {
        ...
        try {           
            ...
            return Redirect::route('employee.home')->with('success', 'Your experience data delete successful');
