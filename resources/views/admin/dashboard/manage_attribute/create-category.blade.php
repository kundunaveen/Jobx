...
@section('title')
    Admin | Manage Master Attribute Category
@endsection
@section('content')
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header">
                                    <div class="row justify-content-between">
                                        <h3 class="card-title col-auto mt-2">Add Master Attribute Category</h3>
                                        <a class="col-auto btn btn-primary" href="{{ route('admin.categories') }}" style="margin-right:10px !important">Back</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input type="text" maxlength="65" name="name" class="form-control @error('name') is-invalid @enderror" required>
                                                @error('name')
