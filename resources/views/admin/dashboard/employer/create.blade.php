                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header">
                                    <div class="row justify-content-between">
                                        <h3 class="card-title col-auto mt-2">Add Employer</h3>
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="row"> 
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" maxlength="100" value="{{ old('first_name') }}" name="first_name" class="form-control @error('first_name') is-invalid @enderror" >
                                                @error('first_name')
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" maxlength="100" value="{{ old('last_name') }}" name="last_name" class="form-control @error('last_name') is-invalid @enderror" >
                                                @error('last_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="mt-4 row"> 
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" maxlength="100" value="{{ old('company_name') }}" name="company_name" class="form-control @error('company_name') is-invalid @enderror" >
                                                @error('company_name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="mt-4 row"> 
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" maxlength="100" value="{{ old('email') }}" name="email" class="form-control @error('email') is-invalid @enderror" >
                                                @error('email')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="tel" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="15" value="{{ old('contact') }}" name="contact" class="form-control @error('contact') is-invalid @enderror" >
                                                @error('contact')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="mt-4 row"> 
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="password" maxlength="100" name="password_confirmation" class="form-control" >
                                        ...
                                        <div class="mt-4 row"> 
                                            <div class="form-group col-md-6">
                                                ...
                                                <input name="address" maxlength="100" value="{{ old('address') }}" type="text" class="form-control @error('address') is-invalid @enderror" >
                                                @error('address')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="mt-4 row"> 
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="number"  value="{{ old('zip') }}" name="zip" class="form-control @error('zip') is-invalid @enderror" >
                                                @error('zip')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
