                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header">
                                    <div class="row justify-content-between">
                                        <h3 class="card-title col-auto mt-2">Employees</h3>
                                        <a class="col-auto btn btn-primary" href="{{ route('admin.addEmployee') }}" style="margin-right:10px !important">Add Employee</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label class="switch">
                                                    ...
                                                    <input type="hidden" name="activation_status" value="{{$employee->is_active == 0 ? 1 : 0}}">
                                                    @if($employee->is_active == 1)
                                                    <input type="checkbox" name="activation" onclick="changeEmployeeStatus('{{$employee->id}}', 1)" class="checkbutton" checked>
                                                    @else
                                                    <input type="checkbox" name="activation" onclick="changeEmployeeStatus('{{$employee->id}}', 0)" class="checkbutton">
                                                    @endif
                                        ...
                                        <td>
                                            <a href="{{ route('admin.editEmployee', $employee->id) }}" title="edit">
                                            ...
                                            <a href="javascript:void(0)" onclick="deleteEmployee('{{$employee->id}}')" title="delete" class="text-danger">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="22px" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
