                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header">
                                    <div class="row justify-content-between">
                                        <h3 class="card-title col-auto mt-2">Add Job Skill</h3>
                                        <a class="col-auto btn btn-primary" href="{{ route('admin.jobSkills') }}" style="margin-right:10px !important">Back</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="row"> 
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control industries" name="industry_id" required>
                                                    @foreach($industries as $industry)
                                                    <option {{$skill->industry_id == $industry->manage_attribute_category_id ? 'selected':''}} value="{{$industry->id}}">{{$industry->value}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="form-label">Skill <span class="text-danger">*</span></label>
                                                <input type="text" maxlength="65" name="skill" value="{{$skill->skill}}" class="form-control @error('skill') is-invalid @enderror" required>
                                                @error('skill')
