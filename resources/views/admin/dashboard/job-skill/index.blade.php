                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header">
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-auto">
                                            <a class="col-auto btn btn-primary" href="{{ route('admin.addSkill') }}" style="margin-right:10px !important">Add Job Skill</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $index + 1}}</td>
                                        <td>{{$skill->industry->value}}</td>
                                        <td>{{$skill->skill}}</td>
                                        <td>
                                            <a href="{{ url('/admin/job-skills/edit', $skill->id) }}" title="edit">
                                            ...
                                            <a href="javascript:void(0)" onclick="deleteJobSkill('{{$skill->id}}')" title="delete" class="text-danger">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" width="22px" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
