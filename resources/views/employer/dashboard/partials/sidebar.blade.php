    ...
    <aside class="dashboard-aside">
        ...
        <ul class="navbar nav d-block aside-menu">
            <li class="nav-item"><a href="javascript:void(0)" class="nav-link"><i class="navbar-icon icon-dasboard"></i>Dashboard</a></li>
            <li class="nav-item"><a href="{{route('employer.dashboard.posted.jobs')}}" class="nav-link posted-jobs"><i class="navbar-icon icon-recuirment"></i>Recruitment</a></li>
