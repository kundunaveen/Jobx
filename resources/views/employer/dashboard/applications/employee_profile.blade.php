            ...
            <div class="container-fluid">
                            ...
                            <div class="col-lg-4 mb-5 mb-lg-0  ">
                                <div class="card mb-5 mb-lg-0 h-100">
                                    <div class="profile-wrapper card-body text-center">
                                        @if($profile_image = optional($user->profile)->profile_image_url)
                                        <figure class="">
                                            <img src="{{ $profile_image }}" width="230" height="230" alt="Profile Img" class="img-fluid" style="object-fit:cover;border-radius:100%;width:210px;height:210px">
                                        </figure>
                                        @endif
                                        <article>
                                ...
                                <div class="card h-100">
                                    <article class="profile-summary card-body">
                                        ...
                                        <p class="profile-text">
                                            @if ($profile_summary = optional($user->profile)->profile_summary)
                                            {{ $profile_summary }}
                                            @else
                ...
                <section class="about-section">
                    <div class="container">
                        ...
                        <div>
                            <p>
                                @if ($description = optional($user->profile)->description)
                                {{ $description }}
                                @else
