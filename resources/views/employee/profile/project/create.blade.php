            ...
            <div class="card">
                <div class="card-body">
                    <div class="">
                        ...
                        <form class="form-inner" action="{{ route('employee.project.store') }}" method="POST" enctype="multipart/form-data" id="jqueryValidatorAddProjectForm">
                            @csrf
                            ...
                            <div id="copy_form">
                                <div class="row  form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" name="name" value="{{ old('name') }}" required class="form-control form-input" placeholder="Ex: Job Portal website job-ax" aria-label="name">
                                        @error('name')
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" name="role" value="{{ old('role') }}" required class="form-control form-input" placeholder="Ex: Backend Developer" aria-label="inputCompany">
                                        @error('role')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" name="team_size" value="{{ old('team_size') }}" required class="form-control form-input" placeholder="Ex: 5" aria-label="inputCompany">
                                        @error('team_size')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row form-group">
                                    <div class="col-12">
                                        ...
                                        <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Write some 2 or 3 lines in your project">{{ old('description') }}</textarea>
                                        @error('describe')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
